(module
 ...
 (data (i32.const 296) "\"\00\00\00\01\00\00\00\01\00\00\00\"\00\00\00h\00e\00l\00l\00o\00 \00w\00e\00b\00a\00s\00s\00e\00m\00b\00l\00y")
 ...
 (func $~lib/math/murmurHash3 (; 27 ;) (type $FUNCSIG$jj) (param $0 i64) (result i64)
  local.get $0
  i64.const 33
  i64.shr_u
  local.get $0
 ...
 (func $~lib/math/splitMix32 (; 28 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
 ...
 (func $~lib/math/NativeMath.seedRandom (; 29 ;) (type $FUNCSIG$vj) (param $0 i64)
  i32.const 1
 ...
 (func $assembly/index/i32Tof32 (; 30 ;) (type $FUNCSIG$fi) (param $0 i32) (result f32)
  local.get $0
  f32.convert_i32_s
 )
 (func $assembly/index/forLoop (; 31 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/index/add (; 32 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 (func $assembly/index/minus (; 33 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.sub
 )
 ...
 (func $~lib/string/String#concat (; 36 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
